...
namespace MonitorAndAnalysisOfStaffWork.Services
{
    ...
    public class EmployeeService
    {
        ...
        /// </summary>
        /// <param name="number">Табельный номер сотрудника</param>
        /// <returns></returns>
        public async Task<List<EmployeeEntity>> ListByNumber(string number)
        {
            return await ContextApp.Employees.Where(x => x.Number.ToLower().Contains(number.ToLower())).ToListAsync();
        }
